        ...
        <SimpleBar className = {docStyles.documentation}>
            <div>
                ...
                <div className = {docStyles.subsection}>
                    ...
                    <br />
                    <button onClick = {() => {setBanDisplay(!banDisplay)}}>Show</button><br /><br />
                    {banDisplay && <div>
                        <div>
                ...
                <div className = {docStyles.subsection}>
                    ...
                    <br />
                    <button onClick = {() => {setKickDisplay(!kickDisplay)}}>Show</button><br /><br />
                    {kickDisplay && <div>
                        <div>
                            For more advanced usages, you can also use optional command flags:
                        </div>
                ...
                <div className = {docStyles.subsection}>
                    ...
                    <button onClick = {() => {setSetmaxwarningsDisplay(!setmaxwarningsDisplay)}}>Show</button><br /><br />
                    {setmaxwarningsDisplay && <div>
                        <div>
                            Examples:
                        </div><br />
                ...
                <div className = {docStyles.subsection}>
                    ...
                    <button onClick = {() => {setUnbanDisplay(!unbanDisplay)}}>Show</button><br /><br />
                    {unbanDisplay && <div>
                        <div>
                            Examples:
                        </div><br />
                ...
                <div className = {docStyles.subsection}>
                    ...
                    <br />
                    <button onClick = {() => {setWarnDisplay(!warnDisplay)}}>Show</button><br />
                    {warnDisplay && <div>
                        <div>
                            Examples:
                        </div>
                        <br />
                        <div className = {docStyles.commandUsage}>
                            <span className = {docStyles.comment}># warn TOA5T for spamming chat</span><br /><br /><br />
